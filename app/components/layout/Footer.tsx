                ...
                <div className={styles.topRow}>
                    ...
                    <div className={styles.socialCol}>
                        ...
                        <div className={styles.socialLinks}>
                            ...
                            <a href="https://www.instagram.com/caliandrasshow/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Instagram"><Instagram size={20} /></a>
                            <a href="https://www.youtube.com/@CaliantrasTalkShow" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Youtube"><Youtube size={20} /></a>
                            <a href="mailto:caliandrasshow@gmail.com" className={styles.socialIcon} aria-label="Email"><Mail size={20} /></a>
                        </div>
                    </div>
                </div>
