                        ...
                        <div className={styles.authorBox}>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <span className={styles.verPerfilLink}>
                                        VER PERFIL →
                                    </span>
                                </div>
                            </Link>
                ...
                <div className={styles.descriptionLayout}>
                    ...
                    <div className={styles.descriptionMeta}>
                        <div className={styles.metaBlock}>
                            ...
                            <span className={styles.metaValue}>{formatDate(episodio.dataLancamento)}</span>
                        </div>
                        <div className={styles.metaBlock}>
                            <span className={styles.metaLabel}>Formato</span>
                            <span className={styles.metaValue}>{isInstagram ? 'Reel' : 'Talkshow'}</span>
                        </div>
                        <div className={styles.metaBlock}>
